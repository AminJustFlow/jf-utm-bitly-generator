...
export class FallbackCommandParser {
  parse(message) {
    ...
    return ParsedLinkRequest.fromObject({
      ...
      utm_source: values.utm_source ?? values.source ?? null,
      utm_medium: values.utm_medium ?? values.medium ?? null,
      utm_campaign: values.utm_campaign ?? values.campaign ?? null,
      utm_term: values.utm_term ?? values.term ?? null,
      utm_content: values.utm_content ?? values.content ?? null,
